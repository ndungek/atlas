      ...
      <div className="space-y-5">
        <Reveal delay={0.1}>
          <p className="text-[#ccd6f6] leading-relaxed">
            ...
            <em className="text-[#ffffff]"> “Why does this number matter?”</em>
          </p>
        </Reveal>
        ...
        <Reveal delay={0.5}>
          <p className="text-[#ccd6f6] leading-relaxed italic pt-2">
            Because in the end, I&apos;m not just shaping data — I&apos;m shaping how we{" "}
            <em className="text-[#64ffda]">think</em> with data.
          </p>
        </Reveal>
      </div>
      ...
      <Reveal delay={0.6}>
        <div className="flex flex-wrap gap-3 mt-10">
          {[
            ...
            <span
              key={item}
              className="px-4 py-2 bg-[#0a192f] text-sm text-[#ccd6f6] rounded-lg border border-[#64ffda] hover:border-[#64ffda] hover:text-[#64ffda] transition"
            >
              {item}
            </span>
          ))}
